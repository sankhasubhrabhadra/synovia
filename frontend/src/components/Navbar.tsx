...
import { Sparkles, Plus, Cpu, Sliders, Terminal, ShieldCheck } from "lucide-react";
  ...
  return (
    <header className="h-16 border-b border-slate-800/80 bg-[#0d121f]/90 backdrop-blur-xl sticky top-0 z-40 px-4 md:px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3 cursor-pointer" onClick={onNewProject}>
        <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-purple-500 p-[1px] flex items-center justify-center shadow-lg shadow-indigo-500/20">
      ...
      {/* Center: System Parameter Badges (Google AI Studio Style) */}
      <div className="hidden lg:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900/80 border border-slate-800 text-xs text-slate-300 font-medium">
        ...
        <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-slate-800/60 text-slate-300">
          ...
          <span>Agents: <strong className="text-white">8 Autonomous Swarm</strong></span>
        </div>
        <span className="text-slate-600">•</span>
        <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-slate-800/60 text-slate-300">
          <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" />
          <span>QC: <strong className="text-emerald-400">Anti-SaaS Verification</strong></span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-xs font-bold rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white shadow-lg shadow-blue-500/20 transition-all hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
        >
