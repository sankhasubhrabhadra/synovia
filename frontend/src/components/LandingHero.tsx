  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 md:py-12 relative z-10">
      ...
      >
        ...
        <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-[#fffdfa] leading-tight uppercase">
          Describe Any Startup Idea. <br />
          <span className="text-gradient-gemini">Synthesize An Investor-Ready Strategy.</span>
        </h1>

        <p className="text-sm sm:text-base text-[#d4c4b5] max-w-2xl mx-auto font-bold uppercase tracking-wide leading-relaxed">
      ...
      {/* Main Neo-Brutalist Studio Prompt Box */}
      <motion.div 
        initial={{ opacity: 0, scale: 0.96, y: 10 }}
        animate={{ opacity: 1, scale: 1, y: 0 }}
        transition={{ duration: 0.5, ease: "easeOut" }}
        className="studio-panel p-6 sm:p-8 max-w-4xl mx-auto mb-10 relative overflow-hidden bg-[#251b15] border-4 border-black shadow-[8px_8px_0px_#000000]"
      >
        {/* Workspace Bar Header */}
        <div className="flex flex-wrap items-center justify-between gap-3 pb-4 mb-4 border-b-3 border-black text-xs font-black text-[#d4c4b5]">
          <div className="flex items-center gap-2">
            <Terminal className="w-4 h-4 text-[#f59e0b]" />
            <span className="text-[#fffdfa] uppercase tracking-wider">Prompt Editor</span>
          </div>

          <div className="flex flex-wrap items-center gap-2">
            <span className="px-3 py-1 bg-[#120c09] border-2 border-black text-[11px] text-[#fffdfa] font-black uppercase shadow-[2px_2px_0px_#000000]">
              Swarm: 8 Agents
            </span>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-black text-[#fefae0] uppercase tracking-wider mb-2">
            ...
            <textarea
              ...
              className="w-full px-4.5 py-4 studio-input text-[#fffdfa] placeholder-[#a39284] text-sm font-bold focus:outline-none transition-all resize-none shadow-[4px_4px_0px_#000000] border-3 border-black bg-[#120c09]"
              required
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-1">
            <div className="sm:col-span-2">
              <label className="block text-[11px] font-black text-[#d4c4b5] uppercase tracking-wider mb-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 studio-input text-[#fffdfa] text-xs font-bold placeholder-[#a39284] border-3 border-black bg-[#120c09] shadow-[3px_3px_0px_#000000]"
              />
            </div>
        ...
        <div className="mt-5 pt-4 border-t-3 border-black">
          <span className="text-[11px] font-black text-[#d4c4b5] uppercase tracking-wider block mb-2">
            Try a domain preset:
          </span>
          <div className="flex flex-wrap gap-2">
            {SAMPLE_IDEAS.map((preset, idx) => (
              <button
                ...
                className="chip-pill text-xs px-3.5 py-1.5 text-[#fffdfa] hover:text-black font-bold uppercase cursor-pointer"
              >
                {preset.label}
              </button>
            ))}
      ...
      >
        <div className="studio-card p-5 bg-[#2a1e18] border-3 border-black shadow-[5px_5px_0px_#000000]">
          ...
          <h3 className="font-black text-xs text-[#fffdfa] uppercase tracking-wider mb-1">1. Idea Classifier Agent</h3>
          <p className="text-xs text-[#d4c4b5] font-bold leading-relaxed">
            Classifies into 19 categories (Transportation, Food, Hardware, Healthcare, Marketplace) to prevent SaaS template bias.
          </p>
        </div>

        <div className="studio-card p-5 bg-[#2a1e18] border-3 border-black shadow-[5px_5px_0px_#000000]">
          <div className="w-10 h-10 bg-purple-500 border-2 border-black shadow-[2px_2px_0px_#000000] flex items-center justify-center mb-3">
            <Bot className="w-5 h-5 text-black stroke-[3]" />
          </div>
          <h3 className="font-black text-xs text-[#fffdfa] uppercase tracking-wider mb-1">2. Domain-Specific Swarm</h3>
          <p className="text-xs text-[#d4c4b5] font-bold leading-relaxed">
        ...
        <div className="studio-card p-5 bg-[#2a1e18] border-3 border-black shadow-[5px_5px_0px_#000000]">
          ...
          <h3 className="font-black text-xs text-[#fffdfa] uppercase tracking-wider mb-1">3. Quality Control Audit</h3>
          <p className="text-xs text-[#d4c4b5] font-bold leading-relaxed">
