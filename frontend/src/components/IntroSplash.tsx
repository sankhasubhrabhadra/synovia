...
export function IntroSplash({ onComplete }: IntroSplashProps) {
  ...
  return (
    ...
    >
      {/* Animated Light Mode Mesh Canvas Background */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-[450px] h-[450px] rounded-full bg-gradient-to-tr from-amber-400/35 via-purple-500/25 to-rose-400/35 blur-3xl animate-pulse" style={{ animationDuration: '6s' }} />
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] rounded-full bg-gradient-to-bl from-cyan-400/30 via-indigo-500/25 to-amber-500/30 blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
      </div>

      {/* White Neo-Brutalist Container */}
      <div className="relative z-10 flex flex-col items-center max-w-md px-6 text-center bg-white border-4 border-black p-8 shadow-[10px_10px_0px_#000000]">
        {/* Brutalist Logo Icon */}
        ...
        {/* Brand Name & Tagline */}
        <h1 className="text-4xl font-black tracking-tight text-black uppercase mb-2 flex items-center gap-2">
          <span>SYNOVIA</span>
        ...
        <p className="text-xs font-black text-black tracking-wider uppercase mb-6 bg-[#fefae0] px-3 py-1 border-2 border-black shadow-[3px_3px_0px_#000000]">
          Autonomous 8-Agent Swarm Intelligence
        </p>

        {/* Progress Bar Container */}
        <div className="w-full bg-white p-1 border-3 border-black shadow-[4px_4px_0px_#000000] mb-4">
          <div 
        ...
        <div className="w-full flex items-center justify-between text-xs font-black text-black bg-[#fefae0] px-3 py-2 border-2 border-black shadow-[2px_2px_0px_#000000]">
